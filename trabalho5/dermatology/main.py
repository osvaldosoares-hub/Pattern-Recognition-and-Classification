...
def load_dermatology():
    possible = [
        ...
        os.path.join(TRAB5_DIR, '..', 'trabalho4', 'dermatology', 'dermatology.data'),
        os.path.join(TRAB5_DIR, '..', 'trabalho2', 'dermatology', 'dermatology', 'dermatology.data')
    ]
...
def main():
    ...
    with open('resultado.txt', 'w', encoding='utf-8') as f:
        f.write("TRABALHO 5 - DERMATOLOGY - GMM-BAYES\n")
        f.write("=" * 60 + "\n")
