...
def load_vertebral_data():
    possible = [
        ...
        os.path.join(TRAB5_DIR, '..', 'trabalho4', 'vertebral', 'column_3C.dat'),
        os.path.join(TRAB5_DIR, '..', 'trabalho2', 'Vertebral', 'vertebral+column', 'column_3C.dat')
    ]
...
def plot_decision_surface_full(clf, X_train, y_train, X_test, y_test, class_names, filename):
    ...
    ax.set_title('Superfície de decisão - GMM-Bayes (Vertebral)', fontweight='bold')
    ax.grid(alpha=0.3)
...
def main():
    ...
    with open('resultado.txt', 'w', encoding='utf-8') as f:
        f.write("TRABALHO 5 - VERTEBRAL - GMM-BAYES\n")
        f.write("=" * 60 + "\n")
    ...
    plot_decision_surface_full(clf_plot, best_gmm['X_train'], best_gmm['y_train'],
                               best_gmm['X_test'], best_gmm['y_test'], class_names,
