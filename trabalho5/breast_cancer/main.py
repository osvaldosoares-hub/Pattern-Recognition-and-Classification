...
def load_wdbc():
    possible = [
        ...
        os.path.join(TRAB5_DIR, '..', 'trabalho4', 'breast_cancer', 'wdbc.data'),
        os.path.join(TRAB5_DIR, '..', 'trabalho2', 'Breast Cancer', 'breast+cancer+wisconsin+diagnostic', 'wdbc.data')
    ]
...
def main():
    ...
    with open('resultado.txt', 'w', encoding='utf-8') as f:
        f.write("TRABALHO 5 - BREAST CANCER - GMM-BAYES\n")
        f.write("=" * 60 + "\n")
