...
def load_data():
    ...
    y_raw  = data[:, 6]
    # Encode: Hernia=0, Spondylolisthesis=1, Normal=2
...
def main():
    print("=" * 60)
    print("COLUNA VERTEBRAL  —  Naive Bayes, KNN, DMC")
    print("=" * 60)
    ...
    fig1.suptitle(f'Matrizes de Confusao — Coluna Vertebral  (Realizacao #{med+1})', fontsize=12)
    ...
    fig2.suptitle(f'Superficies de Decisao — Coluna Vertebral\n'
    ...
    plot_gaussians(X, y, r['tr'], r['te'], F1, F2, FEAT_NAMES, cnames, ax,
                   f'Gaussianas NB por Classe — Coluna Vertebral\n'
